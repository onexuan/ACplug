...
public class SwitchView extends View {
    ...
    public SwitchViewType switchViewType=SwitchViewType.SwitchViewTypeGreen;

    public void setSwitchViewType(SwitchViewType type) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setColor(this.switchViewType == SwitchViewType.SwitchViewTypeGreen ? (isOn ? 0xff4bd763 : 0xffe3e3e3) : 0xffe3e3e3);
        ...
        paint.setColor(this.switchViewType == SwitchViewType.SwitchViewTypeGreen ?0xffffffff:0xffe3e3e3);
        canvas.drawPath(sPath, paint);
        canvas.restore();
        // draw center bar
        canvas.save();
        ...
        paint.setColor(this.switchViewType == SwitchViewType.SwitchViewTypeGreen ?(isOn ? 0xff4ada60 : 0xffbfbfbf):0xffbfbfbf);
        canvas.drawPath(bPath, paint);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (enable&&(state == STATE_SWITCH_ON || state == STATE_SWITCH_OFF) && (sAnim * bAnim == 0)) {
