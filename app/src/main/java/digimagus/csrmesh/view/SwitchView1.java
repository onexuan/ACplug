...
/**
 */
public class SwitchView1 extends View {
    ...
    public interface OnStateChangedListener {
        void toggleToOn(SwitchView1 view);

        void toggleToOff(SwitchView1 view);
    }

    private OnStateChangedListener listener = new OnStateChangedListener() {
        @Override
        public void toggleToOn(SwitchView1 view) {
            toggleSwitch(STATE_SWITCH_ON);
        }

        @Override
        public void toggleToOff(SwitchView1 view) {
